...
public class Validador {
	 ...
	 *                o email do aluno.
	 */
	public static void cadastroInvalido(String nome, String matricula, int codigoCurso, String telefone,
			String email) {

		String mensagem = "Erro no cadastro de aluno";

		parametroInvalido(matricula, mensagem + ": matricula de aluno nao pode ser nula");
	...
	public static void ajudaPresencialInvalida(String matrAluno, String disciplina, String horario, String dia,
			String localInteresse) {

		String mensagem = "Erro no pedido de ajuda presencial";

		parametroInvalido(matrAluno, mensagem + ": matricula de aluno nao pode ser vazio ou em branco");
		parametroInvalido(disciplina, mensagem + ": disciplina nao pode ser vazio ou em branco");
		parametroInvalido(horario, mensagem + ": horario nao pode ser vazio ou em branco");
		parametroInvalido(dia, mensagem + ": dia nao pode ser vazio ou em branco");
		parametroInvalido(localInteresse, mensagem + ": local de interesse nao pode ser vazio ou em branco");
	}
	 ...
	 */
	public static void matriculaInvalida(String matricula, String mensagem) {
		if (matricula == null) {
	 ...
	 *                a mensagem a ser exibida na exceção.
	 */
	public static void emailInvalido(String email, String mensagem) {
		if (email == null) {
	 ...
	 *                a mensagem a ser exibida na exceção.
	 */
	public static void validaInteiro(int inteiro, String mensagem) {
		if (inteiro <= 0) {
	...
	public static void notaInvalida(int nota, String mensagem) {
		...
		if (nota > 5) {
			throw new IllegalArgumentException(mensagem + ": nota nao pode ser maior que 5");
		}
	}
	 ...
	 * cadastrada.
	 */
	public static void matriculaCadastrada() {
	 ...
	 *                a mensagem a ser exibida na exceção.
	 */
	public static void alunoInexistente(String mensagem) {
	 ...
	 *                a mensagem a ser exibida na exceção.
	 */
	public static void tutorNaoEncontrado(String mensagem) {
	 ...
	 *                a mensagem a ser exibida na exceção.
	 */
	public static void tutorNaoCadastrado(String mensagem) {
	 ...
	 */
	public static void horarioInvalido(String horario, String mensagem) {
		if (horario == null) {
	 ...
	 *                mensagem a ser exibida na exceção
	 */
	public static void diaInvalido(String dia, String mensagem) {
		if (dia == null) {
	 ...
	 *                mensagem a ser exibida na exceção.
	 */
	public static void localInvalido(String local, String mensagem) {
		if (local == null) {
			throw new NullPointerException(mensagem + " nao pode ser nulo");
		}

		if (local.trim().isEmpty()) {
			throw new IllegalArgumentException(mensagem + " nao pode ser vazio ou em branco");
		}
	}
	 ...
	 *                mensagem a ser exibida na exceção.
	 */
	public static void tornarTutorInvalido(String mensagem) {
	 ...
	 *                mensagem a ser exibida na exceção.
	 */
	public static void proficienciaInvalida(int proficiencia, String mensagem) {
	 ...
	 *                mensagem a ser exibida na exceção.
	 */
	public static void disciplinaInvalida(String disciplina, String mensagem) {
		if (disciplina == null) {
	 ...
	 *                mensagem a ser exibida na exceção.
	 */
	public static void atributoInvalido(String atributo, String mensagem) {
		if (atributo == null) {
			throw new NullPointerException(mensagem + " nao pode ser nulo");
		}
