...
public class Dados {
	...
	public void readMapAlunos(Map<String,Aluno> alunos) {
		throw new UnsupportedOperationException("Num vai dar nn");
	}
	
	public void readMapTutores(Map<String,Tutor> tutores) {
		throw new UnsupportedOperationException("Num vai dar nn");
	}
