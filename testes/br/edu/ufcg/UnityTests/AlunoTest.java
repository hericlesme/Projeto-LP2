...
/**
 * 
 * Classe de Testes de Unidade da classe Aluno.
 * 
...
public class AlunoTest {
	...
	public void testCompareToPositivo() {
		outroAluno = new Aluno("Babi", "12345", 55478, "1234-5678", "babi@tranca.rua");
	...
	public void testCompareToNegativo() {
		outroAluno = new Aluno("Juao", "6666666", 16546, "", "juao.paulo@na.merda");
		assertTrue(aluno.compareTo(outroAluno) < 0);
	}

	/**
	 * Testa o método compareTo com saída neutra, baseado na ordenação lexicográfica
	 * dos nomes de aluno.
	 */
	@Test
	public void testCompareToNeutro() {
		outroAluno = new Aluno("Irineu", "4156418", 16546, "", "soucopia@do.irineu");
		assertTrue(aluno.compareTo(outroAluno) == 0);
	}

	/**
	 * Testa o método que torna o aluno um Tutor, garantindo o acesso aos métodos e
	 * funções de um Tutor.
	 */
	@Test
	...
	public void testAlunosIguais() {
		outroAluno = new Aluno("Fulanim", "116459781", 4185, "0800 777 7000", "fulano@detal.com");
	...
	public void testAlunosDiferentes() {
		outroAluno = new Aluno("Irineu", "116459782", 22345, "", "irineu@vcnaosabe.nem.eu");
	 ...
	 * de atendimento, quando o aluno não é um tutor.
	 */
	 ...
	 * atendimento, quando o aluno não é um tutor.
	 */
	@Test(expected = IllegalThreadStateException.class)
